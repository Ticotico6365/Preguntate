...
urlpatterns = [
    ...
    path('panel_administrador/preguntas_privadas', panel_administrador_priv, name='panel_administrador_privado'),
    path('panel_administrador/preguntas_publicas', panel_administrador_publi, name='panel_administrador_publico'),
